...
export const translations = {
  fr: {
    ...
    suppliersTitle: 'Gestion des Fournisseurs & Achats',
    newSupplier: 'Nouveau Fournisseur',
    newPurchaseInvoice: 'Nouvelle Facture d\'Achat',
    newSupplierPayment: 'Enregistrer un Paiement Fournisseur',
    supplierStatement: 'Situation du Fournisseur',
    supplierInitialDebt: 'Solde Initial / Achats Antérieurs',
    totalPurchases: 'Total Achats',
    totalSupplierPayments: 'Total Payé',
    supplierOutstandingDebt: 'Dette Restante à Payer',
  },
  ar: {
    appName: 'JUST SMILE',
    ...
    noAccount: 'طبيب جديد؟ إنشاء حساب',

    // Credit rules
    creditStatus: 'حالة الرصيد والديون',
    totalDebt: 'إجمالي الدين',
    paidAmount: 'المبلغ المدفوع',
    remainingBalance: 'المبلغ المتبقي',
    overdueAlert: '⚠️ تنبيه: لديك فاتورة متأخرة الدفع (> 20 يومًا). تم إيقاف إمكانية إرسال طلبات جديدة.',
    overdueBadge: 'متأخر',
    ...
    notes: 'ملاحظات وتوجيهات التسليم (اختياري)',
    ...
    payment_partial: 'مدفوعة جزئياً',
    payment_paid: 'مدفوعة بالكامل',

    // Product detail
    technicalSheet: 'البطاقة التقنية',
    specs: 'المواصفات',
    recentlyViewed: 'المنتجات التي تمت مشاهدتها مؤخراً',

    // Admin Dashboard
    pendingDoctors: 'الأطباء في انتظار التفعيل',
    approvedDoctors: 'الأطباء المفعلون',
    approve: 'تفعيل',
    reject: 'رفض',
    lowStock: 'تنبيه نقص المخزون',
    expiryAlerts: 'تنبيه انتهاء الصلاحية',
    importProducts: 'استيراد المنتجات (Excel)',
    importSelectFile: 'اختر ملف إكسل (.xlsx)',
    importReport: 'تقرير الاستيراد',
    importReportSuccess: 'تم استيراد {count} منتج بنجاح.',
    importReportError: 'تم العثور على أخطاء في {count} أسطر.',
    ...
    suppliersTitle: 'إدارة الموردين والمشتريات والدفعات',
    newSupplier: 'مورد جديد',
    newPurchaseInvoice: 'فاتورة شراء جديدة',
    newSupplierPayment: 'تسجيل دفعة لمورد',
    supplierStatement: 'كشف حساب المورد',
    supplierInitialDebt: 'الرصيد الافتتاحي / مشتريات سابقة',
    totalPurchases: 'إجمالي المشتريات',
    totalSupplierPayments: 'إجمالي المدفوعات',
    supplierOutstandingDebt: 'الديون المستحقة للموردين',
  }
};
